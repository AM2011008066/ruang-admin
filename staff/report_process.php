...
<?php
  if(isset($_POST['submit'])){
    ...
    if(empty($errors)):
      ...
      $results      = find_item_by_dates($start_date,$end_date);
    else:
...
<body>
  <?php if($results): ?>
    <div class="page-break">
       <div class="sale-head">
           <h1>JPK Inventory Management System Report</h1>
      ...
      <table class="table table-border">
        ...
        <tbody>
          <?php foreach($results as $result): ?>
           <tr>
              ...
              <td class=""><?php echo remove_junk($result['category']);?></td>
        ...
        <tfoot>
         <tr class="text-right">
           ...
           <td> 
           <?php echo number_format(total_quantity($results)[0]);?>
          </td>
         </tr>
         <!-- <tr class="text-right">
           <td colspan="4"></td>
  ...
  <?php
        ...
        $session->msg("d", "Sorry no item found. ");
        redirect('report.php', false);
     endif;
  ?>
</body>
